...
class Ride(models.Model):
    driver = models.ForeignKey(settings.AUTH_USER_MODEL, null=True, blank=True, on_delete=DO_NOTHING)
    rider = models.ForeignKey(settings.AUTH_USER_MODEL, null=True, blank=True, on_delete=DO_NOTHING)
