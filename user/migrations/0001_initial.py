    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(blank=True, max_length=200, null=True, region=None, unique=True)),
                ...
                ('status', models.ForeignKey(blank=True, default=1, max_length=200, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='option.option')),
