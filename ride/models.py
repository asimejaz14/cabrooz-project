...
class Ride(models.Model):
    ...
    arrived_at_latitude = models.DecimalField(max_digits=19, decimal_places=19, null=True, blank=True)
    arrived_at_longitude = models.DecimalField(max_digits=19, decimal_places=19, null=True, blank=True)
    arrived_at_datetime = models.DateTimeField(max_length=200, null=True, blank=True)
    accepted_at_latitude = models.DecimalField(max_digits=19, decimal_places=19, null=True, blank=True)
    accepted_at_longitude = models.DecimalField(max_digits=19, decimal_places=19, null=True, blank=True)
    accepted_at_datetime = models.DateTimeField(max_length=200, null=True, blank=True)
    pick_up_latitude = models.DecimalField(max_digits=19, decimal_places=19, null=True, blank=True)
    pick_up_longitude = models.DecimalField(max_digits=19, decimal_places=19, null=True, blank=True)
    drop_off_latitude = models.DecimalField(max_digits=19, decimal_places=19, null=True, blank=True)
    drop_off_longitude = models.DecimalField(max_digits=19, decimal_places=19, null=True, blank=True)
